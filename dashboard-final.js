...
<head>
    ...
    <title>Blog Editor Custom Element</title>
    <script>
        class BlogEditor extends HTMLElement {
            ...
            async connectedCallback() {
                        ...
                        <div class="editor-container">
                            <div class="editor-toolbar">
                                ...
                                <div class="editor-actions">
                                    ...
                                    <button class="btn btn-primary" onclick="viewMarkdown()">👁️ View Markdown</button>
                                    <button class="btn btn-primary" onclick="exportMarkdown()">📝 Export MD</button>
                        ...
                        <div id="markdownModal" class="modal">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <span class="close" onclick="closeMarkdownModal()">&times;</span>
                                </div>
                                <div class="modal-body">
                                    <button class="copy-btn" onclick="copyToClipboard('markdown-output')">📋 Copy Markdown</button>
                                ...
                                <div class="modal-body">
                                    <form id="imageForm">
                                        ...
                                        <div class="button-group">
                                            <button type="button" class="btn btn-cancel" onclick="closeImageModal()">Cancel</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="videoForm">
                                        ...
                                        <div class="button-group">
                                            <button type="button" class="btn btn-cancel" onclick="closeVideoModal()">Cancel</button>
                ...
                // Now initialize the editor and functionality
                this.initEditor();
            }
            ...
            initEditor() {
                ...
                class CustomVideoTool {
                    ...
                    getYouTubeEmbedUrl(url) {
                        ...
                        // Use youtube-nocookie.com for privacy-enhanced mode (reduces cookies)
                    ...
                    outputData.blocks.forEach(block => {
                        switch(block.type) {
                            ...
                            case 'customVideo':
                                if (block.data && block.data.url) {
                                    markdown += '\n';
                                    // Use responsive container div for aspect ratio
                                    ...
                                    if (block.data.type === 'youtube') {
                                        ...
                                        // Use youtube-nocookie.com for privacy-enhanced mode (fewer cookies)
