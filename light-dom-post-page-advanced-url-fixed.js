class EnhancedBlogPostViewer extends HTMLElement {
    ...
    _convertImagesInHTML(html) {
        // Fix: Use <template> to prevent eager network fetches of unhandled URLs triggering a redirect.
    ...
    _generateTableOfContents(htmlContent) {
        // Fix: Template tag to prevent early fetch
        const template = document.createElement('template');
    ...
    _formatDate(dateString) {
        ...
        // Fix: Prevent unhandled RangeError crash on invalid dates
