class EnhancedBlogPostViewer extends HTMLElement {
  ...
  initializeUI() {
        ...
        <div id="blog-content-wrapper">
          ...
          <div class="main-content">
            <div class="featured-image-container" id="featuredImageContainer" style="display: none;">
              <img class="featured-image" id="featuredImage" alt="Blog featured image" />
            </div>
    ...
    this.postHeader = this.shadowRoot.getElementById('postHeader');
  ...
  renderPost() {
    ...
    // Render header
    this.postHeader.innerHTML = `
      ${post.category ? `<div class="post-category">${this._escapeHtml(post.category)}</div>` : ''}
      <h1 class="post-title">${this._escapeHtml(post.title)}</h1>
      ${post.excerpt ? `<p class="post-excerpt">${this._escapeHtml(post.excerpt)}</p>` : ''}
    ...
    if (post.featuredImage) {
      this.featuredImage.src = post.featuredImage;
