...
<div class="mdx-msec">
    ...
    _save(status) {
        ...
        const action = status === 'published' ? (this._editPost ? 'Updating' : 'Publishing') : 'Saving draft';
        ...
        this._emit('save-post', {
            ...this._meta, content: md, status, publishedDate, modifiedDate, readTime, structuredData,
