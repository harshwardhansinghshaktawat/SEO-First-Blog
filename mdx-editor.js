...
<div class="msec">
    ...
    async _loadMDXEditor() {
        try {
            ...
            await this._loadScript('https://unpkg.com/react@18/umd/react.production.min.js');
            await this._loadScript('https://unpkg.com/react-dom@18/umd/react-dom.production.min.js');
            
            // Load MDXEditor CSS
            await this._loadCSS('https://unpkg.com/@mdxeditor/editor@latest/dist/style.css');
            
            // Load MDXEditor
            await this._loadScript('https://unpkg.com/@mdxeditor/editor@latest/dist/index.umd.js');
    ...
    _openEditor(post) {
        ...
        // Initialize MDXEditor with content
        setTimeout(() => {
