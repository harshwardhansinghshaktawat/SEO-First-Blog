class EnhancedBlogPostViewer extends HTMLElement {
    ...
    initializeUI() {
        ...
        // Select elements directly from this element (Light DOM)
        ...
        // Handle initial rendering or catch up if Velo set data early
    ...
    getStyles() {
        ...
        // Scoped styling: All selectors are prepended with "enhanced-blog-post-viewer" to protect Wix global styles
        return `
    ...
    connectedCallback() {
        // Trigger UI setup safely inside the correct lifecycle
        if (!this.initialRenderDone) {
            this.initializeUI();
        }
        this.loadMarkedJS();
