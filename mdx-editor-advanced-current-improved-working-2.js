// CUSTOM ELEMENT - Complete Updated Code
...
<div class="mdx-msec">
    ...
    <div style="padding: 14px;">
        <div class="mdx-schema-type-sel">
            ...
            <button class="mdx-schema-type-btn" data-type="NewsArticle">News Article</button>
            <button class="mdx-schema-type-btn" data-type="BlogPosting">Blog Posting</button>
            <button class="mdx-schema-type-btn" data-type="FAQPage">FAQ</button>
        </div>
    </div>
</div>

<div class="mdx-msec" id="schemaArticleFields">
...
<div class="mdx-msec" id="schemaAuthorsSection">
...
<div class="mdx-msec" id="schemaFAQSection" style="display:none;">
    <div class="mdx-msec-title">FAQ Items</div>
    <div style="padding: 14px;">
...
<div class="mdx-msec">
    <div class="mdx-msec-title">Generated Schema Preview</div>
    <div style="padding: 14px;">
    ...
    _wireSchema() {
        this.querySelectorAll('.mdx-schema-type-btn').forEach(btn => {
            btn.addEventListener('click', () => {
                ...
                const articleSection = this.querySelector('#schemaArticleFields');
                const authorsSection = this.querySelector('#schemaAuthorsSection');
                
                if (this._schemaType === 'FAQPage') {
    ...
    _generateStructuredData() {
        ...
        if (this._schemaType === 'FAQPage') {
            return {
                ...
                "@type": "FAQPage",
                "mainEntity": (this._meta.structuredData.faqItems || []).map(item => ({
                    "@type": "Question",
                    "name": item.question,
                    "acceptedAnswer": {
                        "@type": "Answer",
...
<td>
    ...
    _switchTab(tab) {
        ...
        if (tab === 'schema') this._updateSchemaPreview();
    }
