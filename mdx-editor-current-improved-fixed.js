...
`; }
    ...
    // Helper method to format dates for datetime-local inputs
    ...
    // Helper method to parse date from datetime-local input
...
<div class="mdx-msec">
    ...
    <div class="mdx-mfields">
        ...
        <div class="mdx-mfield"><label>Published Date</label><input class="mdx-minp" type="datetime-local" data-m="publishedDate" id="publishedDateInput"></div>
        <div class="mdx-mfield"><label>Modified Date</label><input class="mdx-minp" type="datetime-local" data-m="modifiedDate" id="modifiedDateInput"></div>
        <div class="mdx-mfield"><label>Read Time (min)</label><input class="mdx-minp" type="number" placeholder="5" data-m="readTime" id="readTimeInput"></div>
    </div>
...
<div class="mdx-msec">
    ...
    _wire() {
        ...
        // Wire all data-m fields with FIXED handling for dates
        this.querySelectorAll('[data-m]').forEach(el => {
            ...
            el.addEventListener(evt, () => {
                ...
                if (el.type === 'checkbox') {
                    ...
                    // Store the date value from the input
                    this._meta[key] = el.value; // Store as string in YYYY-MM-DDTHH:MM format
