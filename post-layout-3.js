// VARIANT 2: MINIMAL CARD LAYOUT - COMPLETE
// Features: Centered single column, card-based sections, collapsible TOC dropdown, generous whitespace, clean typography

class MinimalCardBlogViewer extends HTMLElement {
    constructor() {
        super();
    ...
    initializeUI() {
        this.innerHTML = `
            ...
            <article class="minimal-blog-container">
                ...
                <!-- Author Card -->
                <div class="author-card" id="authorCard" style="display: none;"></div>

                <!-- Tags Card -->
                <div class="tags-card" id="tagsCard" style="display: none;"></div>
        ...
        this.tocDropdown = this.querySelector('#tocDropdown');
        this.tocToggle = this.querySelector('#tocToggle');
        this.tocDropdownContent = this.querySelector('#tocDropdownContent');
        this.contentElement = this.querySelector('#articleContent');
        this.authorCard = this.querySelector('#authorCard');
        this.tagsCard = this.querySelector('#tagsCard');
        ...
        this.tocToggle.addEventListener('click', () => {
            this.tocDropdownContent.classList.toggle('open');
            this.tocToggle.classList.toggle('open');
        });
    }
    ...
    getStyles() {
        ...
        return `
            ...
            minimal-card-blog-viewer * { box-sizing: border-box; }
            
            minimal-card-blog-viewer .minimal-blog-container {
                max-width: 800px;
                margin: 0 auto;
            ...
            /* Card Base Styles */
            minimal-card-blog-viewer .header-card,
            minimal-card-blog-viewer .content-card,
            minimal-card-blog-viewer .author-card,
            minimal-card-blog-viewer .tags-card,
            minimal-card-blog-viewer .share-card {
            ...
            /* Header Card */
            minimal-card-blog-viewer .breadcrumb {
                font-size: 14px;
                color: ${metaText};
                margin-bottom: 20px;
                display: flex;
            ...
            minimal-card-blog-viewer .breadcrumb-item {
                color: ${tocActive};
                text-decoration: none;
            }
            
            minimal-card-blog-viewer .breadcrumb-sep {
                color: ${tableBorder};
            }
            
            minimal-card-blog-viewer .post-title {
            ...
            minimal-card-blog-viewer .meta-row {
                display: flex;
                flex-wrap: wrap;
                gap: 20px;
                align-items: center;
            ...
            minimal-card-blog-viewer .meta-chip {
                display: inline-flex;
                align-items: center;
                gap: 8px;
                background: ${bgColor};
            ...
            minimal-card-blog-viewer .meta-chip svg {
                width: 16px;
                height: 16px;
                fill: ${tocActive};
            }
            
            minimal-card-blog-viewer .view-badge {
            ...
            /* TOC Dropdown */
            minimal-card-blog-viewer .toc-dropdown {
                margin-bottom: 30px;
            }
            
            minimal-card-blog-viewer .toc-toggle {
                width: 100%;
                background: ${tocBg};
            ...
            minimal-card-blog-viewer .toc-toggle:hover {
                background: ${tableRowAltBg};
                border-color: ${tocActive};
            }
            
            minimal-card-blog-viewer .toc-toggle.open .chevron {
                transform: rotate(180deg);
            }
            
            minimal-card-blog-viewer .toc-toggle .chevron {
                transition: transform 0.3s;
                margin-left: auto;
            }
            
            minimal-card-blog-viewer .toc-dropdown-content {
                max-height: 0;
                overflow: hidden;
            ...
            minimal-card-blog-viewer .toc-dropdown-content.open {
                max-height: 600px;
                padding: 20px 24px 24px;
                overflow-y: auto;
            }
            
            minimal-card-blog-viewer .toc-list {
                list-style: none;
                padding: 0;
                margin: 0;
            }
            
            minimal-card-blog-viewer .toc-list li {
                margin-bottom: 4px;
            }
            
            minimal-card-blog-viewer .toc-list a {
                color: ${tocText};
                text-decoration: none;
                display: block;
                padding: 10px 14px;
            ...
            minimal-card-blog-viewer .toc-list a:hover,
            minimal-card-blog-viewer .toc-list a.active {
                color: ${tocActive};
            ...
            minimal-card-blog-viewer #articleContent {
                font-size: 18px;
                line-height: 1.9;
                color: ${paragraphColor};
            }
            
            minimal-card-blog-viewer #articleContent h2 {
            ...
            minimal-card-blog-viewer #articleContent h3 {
            ...
            minimal-card-blog-viewer #articleContent h4 {
            ...
            minimal-card-blog-viewer #articleContent h5 {
            ...
            minimal-card-blog-viewer #articleContent h6 {
            ...
            minimal-card-blog-viewer #articleContent p {
                margin-bottom: 30px;
                line-height: 1.9;
            }
            
            minimal-card-blog-viewer #articleContent a {
                color: ${linkColor};
                text-decoration: none;
                font-weight: 600;
            ...
            minimal-card-blog-viewer #articleContent a:hover {
                opacity: 0.7;
            }
            
            minimal-card-blog-viewer #articleContent strong {
                font-weight: 700;
                color: ${strongColor};
            }
            
            minimal-card-blog-viewer #articleContent em {
                font-style: italic;
            }
            
            minimal-card-blog-viewer #articleContent del {
                text-decoration: line-through;
                opacity: 0.7;
            }
            
            minimal-card-blog-viewer #articleContent ul,
            minimal-card-blog-viewer #articleContent ol {
                margin-bottom: 30px;
                padding-left: 30px;
            }
            
            minimal-card-blog-viewer #articleContent li {
                margin-bottom: 14px;
                line-height: 1.8;
            }
            
            minimal-card-blog-viewer #articleContent blockquote {
                margin: 40px 0;
                padding: 30px 40px;
            ...
            minimal-card-blog-viewer #articleContent code {
                background: ${codeBg};
                padding: 4px 10px;
                border-radius: 6px;
            ...
            minimal-card-blog-viewer #articleContent pre {
                background: ${codeBg};
                padding: 28px;
                border-radius: 16px;
                overflow-x: auto;
            ...
            minimal-card-blog-viewer #articleContent pre code {
            ...
            minimal-card-blog-viewer #articleContent img {
                max-width: 100%;
                height: auto;
                border-radius: 16px;
                margin: 40px auto;
            ...
            minimal-card-blog-viewer #articleContent hr {
                border: none;
            ...
            /* Tables */
            minimal-card-blog-viewer .table-wrapper {
                overflow-x: auto;
                margin: 40px 0;
                border-radius: 12px;
            }
            
            minimal-card-blog-viewer #articleContent table {
                width: 100%;
            ...
            minimal-card-blog-viewer #articleContent table th,
            minimal-card-blog-viewer #articleContent table td {
                padding: 16px 20px;
                text-align: left;
            ...
            minimal-card-blog-viewer #articleContent table tbody tr:nth-child(even) {
                background: ${tableRowAltBg};
            }
            
            /* Video Embeds */
            minimal-card-blog-viewer .video-embed {
                position: relative;
            ...
            minimal-card-blog-viewer .video-embed iframe {
                position: absolute;
                top: 0;
                left: 0;
                width: 100%;
            ...
            minimal-card-blog-viewer .author-avatar {
                width: 80px;
                height: 80px;
                border-radius: 50%;
                object-fit: cover;
            ...
            minimal-card-blog-viewer .author-info h3 {
                font-size: 22px;
                font-weight: 800;
                color: ${paragraphColor};
                margin: 0 0 8px;
            ...
            minimal-card-blog-viewer .author-info p {
                font-size: 15px;
                color: ${metaText};
                margin: 0;
                line-height: 1.6;
            ...
            minimal-card-blog-viewer .tags-title {
                font-size: 14px;
                font-weight: 700;
                color: ${metaText};
            ...
            minimal-card-blog-viewer .tags-list {
                display: flex;
                gap: 10px;
                flex-wrap: wrap;
            }
            
            minimal-card-blog-viewer .tag {
                background: ${tagBg};
                color: ${tagText};
                padding: 10px 20px;
                border-radius: 24px;
            ...
            minimal-card-blog-viewer .tag:hover {
            ...
            minimal-card-blog-viewer .share-label {
                font-size: 16px;
                font-weight: 700;
                color: ${metaText};
                margin-bottom: 20px;
            ...
            minimal-card-blog-viewer .share-buttons {
                display: flex;
            ...
            minimal-card-blog-viewer .share-btn {
                width: 52px;
                height: 52px;
                border-radius: 50%;
            ...
            minimal-card-blog-viewer .share-btn svg {
                width: 22px;
                height: 22px;
                fill: currentColor;
            }
            
            minimal-card-blog-viewer .share-btn:hover {
            ...
            /* Related Section */
            minimal-card-blog-viewer .related-section {
                margin-top: 60px;
            }
            
            minimal-card-blog-viewer .related-title {
                font-size: 32px;
                font-weight: 900;
                color: ${h2Color};
                text-align: center;
            ...
            minimal-card-blog-viewer .related-grid {
                display: grid;
                grid-template-columns: repeat(auto-fit, minmax(320px, 1fr));
                gap: 24px;
            }
            
            minimal-card-blog-viewer .related-card {
            ...
            minimal-card-blog-viewer .related-card:hover {
                transform: translateY(-6px);
                box-shadow: 0 12px 32px rgba(0, 0, 0, 0.5);
                border-color: ${relatedCategory};
            }
            
            minimal-card-blog-viewer .related-image {
                width: 100%;
                height: 200px;
                object-fit: cover;
            }
            
            minimal-card-blog-viewer .related-content {
                padding: 24px;
            }
            
            minimal-card-blog-viewer .related-category {
            ...
            minimal-card-blog-viewer .related-title-text {
                font-size: 20px;
                font-weight: 800;
                color: ${relatedTitle};
                margin-bottom: 12px;
            ...
            minimal-card-blog-viewer .related-excerpt {
                font-size: 14px;
    ...
    renderPost() {
        ...
        `;
        this.authorCard.style.display = 'flex';
    ...
    _renderContent(markdown) {
        ...
        if (result.toc) {
            this.tocDropdownContent.innerHTML = result.toc;
            this.tocDropdown.style.display = 'block';
    ...
    _generateTableOfContents(htmlContent) {
        ...
        tocItems.forEach(item => {
            tocHtml += `<li><a href="#${item.id}" data-heading-id="${item.id}">${this._escapeHtml(item.text)}</a></li>`;
        });
        tocHtml += `</ul>`;
    ...
    _addSmoothScrollToTOC() {
        const tocLinks = this.tocDropdownContent.querySelectorAll('a[href^="#"]');
        tocLinks.forEach(link => {
            link.addEventListener('click', (e) => {
                ...
                if (targetElement) {
                    ...
                    this.tocDropdownContent.classList.remove('open');
...
customElements.define('minimal-card-blog-viewer', MinimalCardBlogViewer);
