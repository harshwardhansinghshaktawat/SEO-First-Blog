// CUSTOM ELEMENT - Updated with improvements
...
// CUSTOM ELEMENT - Continuation from bestPractices section
    ...
    _editImageAlt() {
        ...
        const selection = this._toastEditor.getSelectedText();
        const markdown = this._toastEditor.getMarkdown();
        const cursorPos = this._toastEditor.getCurrentModeEditor().getSelection();
