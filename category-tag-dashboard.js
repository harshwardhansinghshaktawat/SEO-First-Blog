...
class BlogDashboard extends HTMLElement {
    ...
    static get observedAttributes() {
        return ['categories-data', 'tags-data', 'posts-data', 'save-result', 'delete-result'];
    }
                ...
                <tbody>
                    ${items.map(item => `
                        <tr>
                            ...
                            <td>
                                <div style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap; color: #9ca3af;">
        ...
        if (this.state.allPosts.length === 0) {
            selector.innerHTML = `
                <div class="empty-state" style="padding: 40px 20px;">
                    ...
                    <p style="margin: 12px 0 0 0; color: #6b7280;">No posts available</p>
                </div>
            `;
            return;
        }
